...
/**
 * root route shunt:Only jump to the target page according to the login status and menu permissions.*/
export function EntryRedirect() {
 ...
 reason:'no-accessible-entry',from:returnTo,deniedPath:buildLocationPath(location),})}
 replace
 />)
 }
