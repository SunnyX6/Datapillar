...
/**
 * permission boundaries:Determine whether to allow access based only on routing permission metadata.*/
export function PermissionBoundary() {
 ...
 reason:'permission-denied',from:returnTo,deniedPath:currentPath,})}
 replace
 />)
 }
