...
export const TableBasicForm = forwardRef<TableBasicFormHandle,TableBasicFormProps>(({ initialData },ref) => {
 ...
 Modifying the table name may affect the SQL and ETL Task,Please operate with caution.Table parameters are used to configure the storage engine,Advanced attributes such as partitions.</p>
 </div>
 ...
 ⚠️ Modifying the table name may affect the SQL and ETL Task
 </p>)}
 </div>
 ...
 placeholder="Accurate business description is more helpfulAIgeneration..."
 rows={3}
