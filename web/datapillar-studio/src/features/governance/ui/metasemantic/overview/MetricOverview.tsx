...
export function MetricOverview({ metric,onClose,onVersionSwitch }:MetricOverviewProps) {
 ...
 v{selectedVersion}
 {selectedVersion!== metric.currentVersion && (<span className="text-amber-500 ml-1">(Not current)</span>)}
 </span>
 ...
 {loading?<SkeletonBlock className="h-5 w-full max-w-[26rem]" />:versionDetail?.comment || 'No business description yet...'}
 </p>
 </div>
 ...
 <Info size={iconSizeToken.small} className="text-blue-500" /> Technical properties
 </div>
 ...
 <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
 <div className="text-micro font-semibold text-slate-400 uppercase mb-0.5">Current version</div>
 <div className="text-body-sm font-mono font-semibold text-slate-700 dark:text-slate-300">v{metric.currentVersion}</div>
 </div>
 <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
 <div className="text-micro font-semibold text-slate-400 uppercase mb-0.5">unit</div>
 <div className="text-body-sm font-semibold text-slate-700 dark:text-slate-300">
 ...
 <section>
 <div className="text-micro font-semibold text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-1.5">
 <Code size={iconSizeToken.small} className="text-blue-500" /> Calculation formula
 </div>
 ...
 <section>
 <div className="text-micro font-semibold text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-1.5">
 <GitBranch size={iconSizeToken.small} className="text-blue-500" /> Upstream and downstream bloodline preview
 </div>
 ...
 <span className="text-caption font-medium">The ancestry map is loading...</span>
 </div>
 </div>
 </section>
 </div>
 ...
 <span className="text-micro font-semibold text-slate-500">Version history</span>
 <button
 ...
 {versions.length === 0?(<div className="p-4 text-center text-slate-400 text-caption">No historical version yet</div>):(versions.map((v) => (<button
 key={v}
 ...
 {v === metric.currentVersion && (<span className="text-micro text-emerald-500 font-medium">current</span>)}
