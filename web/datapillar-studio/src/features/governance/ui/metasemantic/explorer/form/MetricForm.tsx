        ...
        .then((versionData) => {
          ...
          try {
            if (versionData.measureColumns) {
              measureColumns =
                typeof versionData.measureColumns === 'string'
                  ? JSON.parse(versionData.measureColumns)
                  : versionData.measureColumns
            }
            if (versionData.filterColumns) {
              const parsed =
                typeof versionData.filterColumns === 'string'
                  ? JSON.parse(versionData.filterColumns)
                  : versionData.filterColumns
