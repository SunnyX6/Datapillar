                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {group.danger && (
                                    <span className={`${TYPOGRAPHY.micro} text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-500/10 border border-rose-100 dark:border-rose-500/30 px-1.5 rounded font-medium`}>
                                      High Risk
                                    </span>
                                  )}
                                </div>
