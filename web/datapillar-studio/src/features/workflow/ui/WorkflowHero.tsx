...
export function WorkflowHero() {
 ...
 <h3 className="text-xl font-semibold tracking-tight text-slate-800 dark:text-white">Waiting for tasks</h3>
 <p className="text-xs text-slate-500 dark:text-slate-400">Enter your requirements on the left,AI Workflow blueprint will be drawn automatically.</p>
 </div>
 </div>
 </>)
}
