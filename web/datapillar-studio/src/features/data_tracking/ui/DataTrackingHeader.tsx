...
export function DataTrackingHeader({ onCreateSchema,onCreateTracking }:DataTrackingHeaderProps) {
 ...
 One-stop management event model(Schema)and buried point plan(Plan),Abstract business actions into standard events,And implement it on all ends.</p>
 </div>
 </div>
 </div>
