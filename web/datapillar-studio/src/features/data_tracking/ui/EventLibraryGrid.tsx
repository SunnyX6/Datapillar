    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 @md:flex-row @md:items-center @md:justify-between">
        <div className="relative w-full @md:max-w-xs">
          ...
          <input
            type="text"
            placeholder="Search meta events..."
      ...
      <div className="grid grid-cols-1 @md:grid-cols-2 @xl:grid-cols-3 gap-4">
                    ...
                    <>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {schema.standardProperties.length === 0 ? (
                          <span className="text-nano text-slate-400">No standard properties yet</span>
                        ) : (
        ...
        >
          ...
          <span className="text-body-sm font-bold">Add new meta event</span>
          <span className="text-caption mt-1 text-center">Create reusable event templates</span>
        </button>
      </div>
    </div>
  )
