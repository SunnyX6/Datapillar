...
const HERO_FEATURES = [
  { key: 'isolation', icon: Layers, tone: 'text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10 dark:text-indigo-300' },
  { key: 'chunking', icon: Sparkles, tone: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 dark:text-emerald-300' },
  { key: 'retrieval', icon: Search, tone: 'text-sky-600 bg-sky-50 dark:bg-sky-500/10 dark:text-sky-300' }
]
...
export function WikiHero({ onCreate }:WikiHeroProps) {
 ...
 <div className="grid grid-cols-1 @md:grid-cols-3 gap-4">
	 ...
	 return (<Card key={feature.key} padding="sm" className="text-left h-full">
