...
export function LLMModels({
  ...
  const selectedModels = useMemo(
    () => models.filter((model) => selectedModelIds.includes(model.aiModelId)),
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
            <tr>
              ...
              {models.map((model) => (
                <td key={model.aiModelId} className="p-4 text-body-sm font-mono text-slate-800 dark:text-slate-200">
            ...
            <tr>
              ...
              {models.map((model) => (
                <td key={model.aiModelId} className="p-4 text-body-sm text-slate-800 dark:text-slate-200">
                  {model.stats.params ? (
            ...
            <tr>
              ...
              {models.map((model) => (
                <td key={model.aiModelId} className="p-4">
            ...
            <tr>
              ...
              {models.map((model) => (
                <td key={model.aiModelId} className="p-4 text-caption text-slate-500 dark:text-slate-400 leading-relaxed align-top">
                  {model.description}
                </td>
              ))}
            </tr>
