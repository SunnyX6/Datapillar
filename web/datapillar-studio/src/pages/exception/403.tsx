...
export function ForbiddenPage() {
 ...
 const description = 'sorry,You do not have permission to access the current page,Please contact the administrator to assign menu permissions.'
 ...
 return (<div className="min-h-dvh bg-slate-50 flex flex-col items-center justify-center px-6 py-10 dark:bg-[#020617]">
 <motion.div
 ...
 <h2 className="mb-3 text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">restricted access</h2>
 <p className="mb-8 text-body-sm leading-relaxed text-slate-500 dark:text-slate-400">
 {description}
 </p>

 {routeQuery.deniedPath?(<p className="mb-8 text-caption text-slate-400 dark:text-slate-500">
 restricted path:{routeQuery.deniedPath}
 </p>):null}
 ...
 If you think this is a bug,Please contact the system administrator to apply for relevant permissions.</p>
 </div>
 </motion.div>
 </div>)
}
