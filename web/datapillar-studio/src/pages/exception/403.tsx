...
export function ForbiddenPage() {
 ...
 const description = t('forbidden.description')
 ...
 <h2 className="mb-3 text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">{t('forbidden.title')}</h2>
 ...
 {t('forbidden.restrictedPathLabel')}:{routeQuery.deniedPath}
 </p>):null}
