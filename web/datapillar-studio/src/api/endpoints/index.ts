...
export const API_PATH = {
  ...
  llm: {
    models: '/llms/models',
    modelDetail: (aiModelId: number) => `/llms/models/${aiModelId}`,
    modelConnect: (aiModelId: number) => `/llms/models/${aiModelId}/connect`,
    ...
    userModel: (userId: number, aiModelId: number) =>
      `/llms/users/${userId}/models/${aiModelId}`,
    currentUserDefaultModel: (aiModelId: number) => `/llms/models/${aiModelId}/default`
  },
  knowledgeGraph: {
    initial: '/initial',
    search: '/search'
