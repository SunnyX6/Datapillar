...
export function Navbar({ onRequestAccess }: NavbarProps) {
  ...
  return (
    <nav
      className={cn(
        'fixed left-0 right-0 top-0 z-50 border-b pt-4 pb-4 transition-colors duration-300',
        isScrolled
          ? 'bg-[#020410]/80 backdrop-blur-md border-violet-500/10'
          : 'bg-transparent border-transparent'
      )}
    >
      <div className={`${contentMaxWidthClassMap.ultraWide} mx-auto flex items-center justify-between px-8`}>
        <div className="flex items-center space-x-3 group cursor-pointer">
          <div className="flex h-11 w-11 items-center justify-center">
            <img src={brandLogo} alt="Datapillar" className="h-11 w-11 object-contain" />
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-bold text-white tracking-tight leading-none">Datapillar</span>
