...
public class GatewayForbiddenException extends ForbiddenException {
    ...
    public GatewayForbiddenException(String type, Map<String, String> context, String message, Object... args) {
        super(type, context, message, args);
    }

    public GatewayForbiddenException(Throwable cause,
                  String type,
