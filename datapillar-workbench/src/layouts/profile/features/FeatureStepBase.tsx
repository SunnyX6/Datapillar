          ...
          {releaseStages.map((stage) => {
            ...
            return (
              <Card
                ...
                className={cn(
                  cardClassName,
                  'flex flex-col items-center justify-center gap-1.5 px-3 h-20 transition-colors cursor-pointer w-[140px] shadow-none dark:shadow-none text-center focus:outline-none focus-visible:ring-0 relative',
