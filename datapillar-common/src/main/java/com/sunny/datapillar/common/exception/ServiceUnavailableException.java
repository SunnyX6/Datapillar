...
/**
 * ServiceUnavailableAbnormal DescriptionServiceUnavailableException semantics and error context
 *
 * @author Sunny
 * @date 2026-01-01
 */
public class ServiceUnavailableException extends DatapillarRuntimeException {
  ...
  public ServiceUnavailableException(Throwable cause, String message, Object... args) {
    super(
        cause, Code.SERVICE_UNAVAILABLE, ErrorType.SERVICE_UNAVAILABLE, null, true, message, args);
  }
