...
/**
 * Unified error type constants Business semantics unified through type Field passing
 *
 * @author Sunny
 * @date 2026-02-23
 */
public final class ErrorType {
  ...
  public static final String TENANT_PRIVATE_KEY_ALREADY_EXISTS =
  ...
  public static final String INVITATION_USERNAME_ALREADY_EXISTS =
      "INVITATION_USERNAME_ALREADY_EXISTS";
