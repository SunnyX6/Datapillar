...
/**
 * Constraint name extractor Responsible for extracting constraint names from database exception
 * messages
 *
 * @author Sunny
 * @date 2026-02-26
...
public final class ConstraintNameExtractor {
  ...
  private static final Pattern MYSQL_KEY_PATTERN =
      Pattern.compile("for key\\s+[`\"']?([a-zA-Z0-9_.$-]+)[`\"']?", Pattern.CASE_INSENSITIVE);
