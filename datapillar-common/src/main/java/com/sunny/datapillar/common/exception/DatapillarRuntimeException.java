...
/**
 * RuntimeAbnormal DescriptionRuntimeException semantics and error context
 *
 * @author Sunny
 * @date 2026-01-01
 */
public class DatapillarRuntimeException extends RuntimeException {
  ...
  protected DatapillarRuntimeException(int code, String type, String message, Object... args) {
    this(code, type, null, false, null, format(message, args));
  }

  protected DatapillarRuntimeException(
      int code,
      String type,
  ...
  protected DatapillarRuntimeException(
      Throwable cause, int code, String type, String message, Object... args) {
  ...
  private DatapillarRuntimeException(
      int code,
      String type,
      Map<String, String> context,
      boolean retryable,
