...
/**
 * OpenAPI response schema config for auth API paging-field customization.
 *
 * @author Sunny
 * @date 2026-01-01
 */
...
public class OpenApiConfig {
  ...
  private static final String SUCCESS_CODE_DESC = "Business status code, 0 means success";
                          ...
                          operation -> {
                            ...
                            for (ApiResponse response : operation.getResponses().values()) {
                              ...
                              for (MediaType mediaType : response.getContent().values()) {
                                ...
                                Schema<?> targetSchema =
                                    resolveSchema(openApi, mediaType.getSchema());
