...
/**
 * DingTalk SSO provider implementation.
 *
 * @author Sunny
 * @date 2026-01-01
 */
...
public class DingtalkSsoProvider implements SsoProvider {
  ...
  public SsoQrResponse buildQr(SsoProviderConfig config, String state) {
    ...
    String responseType =
        pickOrDefault(config.getOptionalString("responseType"), DEFAULT_RESPONSE_TYPE);
  ...
  public SsoToken exchangeCode(SsoProviderConfig config, String authCode) {
    ...
    try {
      com.aliyun.dingtalkoauth2_1_0.Client client =
          new com.aliyun.dingtalkoauth2_1_0.Client(buildOpenApiConfig());
      ...
      if (response == null
        ...
        throw new com.sunny.datapillar.common.exception.InternalException(
            "SSO request failed: %s", "accessToken is empty");
      }
      ...
      throw new com.sunny.datapillar.common.exception.InternalException(
          "SSO request failed: %s", e.getMessage());
    }
  }
  ...
  public SsoUserInfo fetchUserInfo(SsoProviderConfig config, SsoToken token) {
    ...
    try {
      ...
      if (response == null || response.getBody() == null) {
        throw new com.sunny.datapillar.common.exception.InternalException(
            "SSO request failed: %s", "User info is empty");
      }
  ...
  private Map<String, Object> toMap(Object value) {
    try {
      ...
      throw new com.sunny.datapillar.common.exception.InternalException(
          e, "SSO request failed: %s", "dingtalk_token_response_convert_failed");
    }
  }
  ...
  private String toJson(Object value) {
    try {
      ...
      throw new com.sunny.datapillar.common.exception.InternalException(
          e, "SSO request failed: %s", "dingtalk_user_info_serialize_failed");
    }
  }
