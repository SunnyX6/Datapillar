...
public class GatewayAssertionVerifier {
    ...
    public GatewayAssertionContext verify(String token, String requestMethod, String requestPath) {
        ...
        boolean impersonation = Boolean.TRUE.equals(claims.get(GatewayAssertionClaims.IMPERSONATION, Boolean.class));
        Long actorUserId = parseLong(claims.get(GatewayAssertionClaims.ACTOR_USER_ID));
        Long actorTenantId = parseLong(claims.get(GatewayAssertionClaims.ACTOR_TENANT_ID));
