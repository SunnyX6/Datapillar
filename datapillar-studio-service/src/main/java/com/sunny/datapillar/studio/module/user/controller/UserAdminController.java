...
/**
 * User Management Controller Responsible for user management interface orchestration and request
 * processing
 *
 * @author Sunny
 * @date 2026-01-01
...
public class UserAdminController {
  ...
  public ApiResponse<Void> update(
      @PathVariable Long id, @Valid @RequestBody UserUpdateRequest dto) {
