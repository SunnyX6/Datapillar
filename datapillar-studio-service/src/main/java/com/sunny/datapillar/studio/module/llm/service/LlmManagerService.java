...
/**
 * large modelManagerservice Large models availableManagerBusiness capabilities and domain services
 *
 * @author Sunny
 * @date 2026-01-01
 */
public interface LlmManagerService {
  ...
  List<LlmModelResponse> listModels(
  ...
  List<LlmUserModelUsageResponse> listUserModelUsages(
      Long operatorUserId, Long targetUserId, boolean onlyEnabled);

  List<LlmUserModelPermissionResponse> listUserModelPermissions(
      Long operatorUserId, Long targetUserId, boolean onlyEnabled);

  void upsertUserModelGrant(
  ...
  LlmUserModelUsageResponse setUserDefaultModel(
