...
/**
 * Safe exception handler Responsible for the security exception handling process and result output
 *
 * @author Sunny
 * @date 2026-01-01
 */
...
public class SecurityExceptionHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
  ...
  public void commence(
    ...
    writeError(
        ...
        new com.sunny.datapillar.common.exception.UnauthorizedException(
            authException, "Unauthorized access"));
  }
  ...
  public void handle(
      ...
      throws IOException, ServletException {
    log.warn("No access: {}", accessDeniedException.getMessage(), accessDeniedException);
    writeError(
        response,
