...
/**
 * DingtalkBindingclient responsibleDingtalkBindingClient call and protocol encapsulation
 *
 * @author Sunny
 * @date 2026-01-01
 */
  ...
  public DingtalkUserInfo fetchUserInfo(String clientId, String clientSecret, String authCode) {
    ...
    try {
      com.aliyun.dingtalkoauth2_1_0.Client oauthClient =
          new com.aliyun.dingtalkoauth2_1_0.Client(buildConfig());
      ...
      String accessToken =
          tokenResponse == null || tokenResponse.getBody() == null
              ? null
      ...
      GetUserResponse userResponse =
          contactClient.getUserWithOptions("me", headers, new RuntimeOptions());
