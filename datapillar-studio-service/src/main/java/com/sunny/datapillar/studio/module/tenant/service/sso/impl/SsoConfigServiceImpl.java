...
/**
 * Single sign-on configuration service implementation Implement single sign-on configuration
 * business process and rule verification
 *
 * @author Sunny
 * @date 2026-01-01
 */
...
public class SsoConfigServiceImpl implements SsoConfigService {
  ...
  private Map<String, Object> mergeConfig(
      String tenantCode, Map<String, Object> base, SsoDingtalkConfigItem input) {
    if (input == null) {
      throw new InvalidSsoConfigRequestException();
    }
