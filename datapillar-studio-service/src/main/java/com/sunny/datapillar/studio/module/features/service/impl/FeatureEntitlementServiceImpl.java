...
public class FeatureEntitlementServiceImpl implements FeatureEntitlementService {
    ...
    private Permission resolvePermission(FeatureEntitlementDto.UpdateItem item,
        ...
        if (item.getPermissionId() != null) {
            ...
            if (permission == null) {
                throw new BusinessException(ErrorCode.INVALID_ARGUMENT, String.valueOf(item.getPermissionId()));
            }
            return permission;
        }
        ...
        if (permission == null) {
            throw new BusinessException(ErrorCode.INVALID_ARGUMENT, normalizedCode);
        }
        return permission;
    }
