        ...
        <div className="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between flex-shrink-0 bg-slate-50/50 dark:bg-slate-800/50">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-blue-600 text-white rounded-xl shadow-md">
              <Book size={iconSizeToken.large} />
            </div>
            <div>
              <h2 className="font-semibold text-slate-900 dark:text-slate-100 text-body">词根详情</h2>
              <div className="text-micro text-slate-400 dark:text-slate-500 font-semibold uppercase tracking-wider">WordRoot Overview</div>
            </div>
          </div>
