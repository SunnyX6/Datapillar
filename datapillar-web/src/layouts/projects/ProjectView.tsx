...
import type { ModuleType, ProjectModule, ProjectTemplateType } from './projectTemplateModules'
import { buildInitialModulesFromTemplates } from './projectTemplateModules'
