-- Datapillar workbench schema
-- 说明：产品库仅存 Workbench 业务数据，tenant_id 仅做逻辑隔离

CREATE DATABASE IF NOT EXISTS datapillar_workbench DEFAULT CHARSET=utf8mb4;
USE datapillar_workbench;
