...
public class OpenLineageAuthFilter extends OncePerRequestFilter {
    ...
    public OpenLineageAuthFilter(GatewayAssertionProperties properties,
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (assertion == null || assertion.isBlank()) {
            securityExceptionHandler.writeError(response, new UnauthorizedException("gateway_assertion_header_missing"));
            return;
        }
        ...
        try {
            ...
            if (context.tokenId() == null || context.tokenId().isBlank()) {
                securityExceptionHandler.writeError(response, new UnauthorizedException("gateway_assertion_token_id_missing"));
                return;
            }
