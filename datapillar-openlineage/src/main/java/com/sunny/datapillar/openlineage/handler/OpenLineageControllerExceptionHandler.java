...
public class OpenLineageControllerExceptionHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(OpenLineageControllerExceptionHandler.class);
    ...
    public ErrorResponse handleValidationException(Exception exception, HttpServletResponse response) {
        ...
        return buildErrorResponse(new com.sunny.datapillar.common.exception.BadRequestException(exception, message), response);
    }
