...
/** Publisher for rebuild command topic. */
@Component
public class RebuildCommandTopicPublisher {

  private final RocketMQTemplate rocketMQTemplate;
  private final OpenLineageRuntimeConfig runtimeProperties;

  public RebuildCommandTopicPublisher(
  ...
  public void retry(String body, String messageKey, Map<String, String> headers, int delaySeconds) {
    ...
    rocketMQTemplate.syncSendDelayTimeSeconds(
        runtimeProperties.getMq().getTopic().getRebuildCommand(), mqMessage, delaySeconds);
  }
