...
public class OpenLineageEventEnvelope {
  ...
  private OpenLineageEventEnvelope(
  ...
  public static OpenLineageEventEnvelope fromRunEvent(
      OpenLineage.RunEvent event, JsonNode rawEvent) {
    return new OpenLineageEventEnvelope(event, rawEvent, RUN_EVENT);
  }

  public static OpenLineageEventEnvelope fromDatasetEvent(
      OpenLineage.DatasetEvent event, JsonNode rawEvent) {
    return new OpenLineageEventEnvelope(event, rawEvent, DATASET_EVENT);
  }

  public static OpenLineageEventEnvelope fromJobEvent(
      OpenLineage.JobEvent event, JsonNode rawEvent) {
  ...
  public Optional<String> facetTenantCode() {
    for (JsonNode datasetNode : datasetNodes()) {
      String value =
          trimToNull(datasetNode.path("facets").path("gravitino").path("tenantCode").asText(null));
      if (value != null) {
        return Optional.of(value);
      }
    }
  ...
  public Optional<String> facetTenantName() {
    for (JsonNode datasetNode : datasetNodes()) {
      String value =
          trimToNull(datasetNode.path("facets").path("gravitino").path("tenantName").asText(null));
      if (value != null) {
        return Optional.of(value);
      }
    }
