...
适用范围：`datapillar-auth`、`datapillar-web-admin`
...
### 3.2 Web-Admin（datapillar-web-admin）
...
## 5. datapillar-web-admin 接口清单与案例
...
- `datapillar-auth` 与 `datapillar-web-admin` 必须依赖该模块
