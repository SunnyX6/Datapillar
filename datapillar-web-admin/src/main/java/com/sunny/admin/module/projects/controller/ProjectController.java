...
public class ProjectController {
    ...
    @GetMapping
    public WebAdminResponse<IPage<ProjectRespDto>> getProjectPage(ProjectQueryReqDto queryDTO) {
    ...
    @GetMapping("/my")
    public WebAdminResponse<IPage<ProjectRespDto>> getMyProjects(ProjectQueryReqDto queryDTO) {
        Long userId = securityUtil.getCurrentUserId();
    ...
    @GetMapping("/{id}")
    public WebAdminResponse<ProjectRespDto> getProjectById(@PathVariable Long id) {
        Long userId = securityUtil.getCurrentUserId();
    ...
    @PostMapping
    public WebAdminResponse<ProjectRespDto> createProject(@Valid @RequestBody ProjectCreateReqDto createDTO) {
        Long userId = securityUtil.getCurrentUserId();
    ...
    public WebAdminResponse<ProjectRespDto> updateProject(
    ...
    public WebAdminResponse<Void> deleteProject(@PathVariable Long id) {
        Long userId = securityUtil.getCurrentUserId();
