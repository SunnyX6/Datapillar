...
public class RoleController {
    ...
    public WebAdminResponse<List<RoleRespDto>> getRoleList() {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public WebAdminResponse<RoleRespDto> getRoleById(@PathVariable Long id) {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('ADMIN')")
    public WebAdminResponse<RoleRespDto> createRole(@Valid @RequestBody RoleReqDto request) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public WebAdminResponse<RoleRespDto> updateRole(@PathVariable Long id, @Valid @RequestBody RoleReqDto request) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public WebAdminResponse<Void> deleteRole(@PathVariable Long id) {
