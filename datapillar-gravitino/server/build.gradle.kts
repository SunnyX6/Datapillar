...
dependencies {
  ...
  implementation(project(":openlineage-listener"))
...
tasks {
  ...
  register<JavaExec>("runServer") {
    group = "application"
    description = "Run Gravitino Server"
    mainClass.set("org.apache.gravitino.server.GravitinoServer")
    classpath = sourceSets["main"].runtimeClasspath
    environment("GRAVITINO_HOME", rootProject.projectDir.absolutePath)
