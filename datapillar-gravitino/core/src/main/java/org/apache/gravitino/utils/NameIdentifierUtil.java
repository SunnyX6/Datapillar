...
public class NameIdentifierUtil {
  ...
  /**
   * Check the given {@link NameIdentifier} is a metric identifier. Throw an {@link
   * IllegalNameIdentifierException} if it's not.
   *
   * @param ident The metric {@link NameIdentifier} to check.
   */
  public static void checkMetric(NameIdentifier ident) {
    NameIdentifier.check(ident != null, "Metric identifier must not be null");
    NamespaceUtil.checkMetric(ident.namespace());
  }

  /**
   * Check the given {@link NameIdentifier} is a metric version identifier. Throw an {@link
   * IllegalNameIdentifierException} if it's not.
   *
   * @param ident The metric version {@link NameIdentifier} to check.
   */
  public static void checkMetricVersion(NameIdentifier ident) {
    NameIdentifier.check(ident != null, "Metric version identifier must not be null");
    NamespaceUtil.checkMetricVersion(ident.namespace());
  }

  /**
   * Check the given {@link NameIdentifier} is a modifier identifier. Throw an {@link
   * IllegalNameIdentifierException} if it's not.
   *
   * @param ident The modifier {@link NameIdentifier} to check.
   */
  public static void checkModifier(NameIdentifier ident) {
    NameIdentifier.check(ident != null, "Modifier identifier must not be null");
    NamespaceUtil.checkModifier(ident.namespace());
  }

  /**
   * Check the given {@link NameIdentifier} is a root identifier. Throw an {@link
   * IllegalNameIdentifierException} if it's not.
   *
   * @param ident The root {@link NameIdentifier} to check.
   */
  public static void checkRoot(NameIdentifier ident) {
    NameIdentifier.check(ident != null, "Root identifier must not be null");
    NamespaceUtil.checkRoot(ident.namespace());
  }
