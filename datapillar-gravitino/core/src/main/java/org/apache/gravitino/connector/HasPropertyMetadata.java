...
public interface HasPropertyMetadata {
  ...
  /**
   * Returns the metric property metadata.
   *
   * @return The metric property metadata.
   * @throws UnsupportedOperationException if the entity does not support metric properties.
   */
  PropertiesMetadata metricPropertiesMetadata() throws UnsupportedOperationException;

  /**
   * Returns the metric version property metadata.
   *
   * @return The metric version property metadata.
   * @throws UnsupportedOperationException if the entity does not support metric version properties.
   */
  PropertiesMetadata metricVersionPropertiesMetadata() throws UnsupportedOperationException;
}
