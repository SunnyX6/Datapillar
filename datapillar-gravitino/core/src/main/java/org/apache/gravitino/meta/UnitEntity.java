...
public class UnitEntity implements Entity, Auditable, HasIdentifier {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UnitEntity)) return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, namespace, unitName, symbol, comment, auditInfo);
  }
  ...
  public static class Builder {
    ...
    public Builder withCode(String code) {
      unitEntity.code = code;
      return this;
    }

    public Builder withNamespace(Namespace namespace) {
      unitEntity.namespace = namespace;
      return this;
    }

    public Builder withUnitName(String unitName) {
      unitEntity.unitName = unitName;
      return this;
    }
    ...
    public Builder withComment(String comment) {
      unitEntity.comment = comment;
      return this;
    }

    public Builder withAuditInfo(AuditInfo auditInfo) {
      unitEntity.auditInfo = auditInfo;
      return this;
    }
