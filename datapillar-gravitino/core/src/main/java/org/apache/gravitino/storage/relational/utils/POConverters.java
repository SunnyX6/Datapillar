...
public class POConverters {
  ...
  public static MetricEntity fromMetricPO(MetricPO metricPO, Namespace namespace) {
    try {
      return MetricEntity.builder()
          .withId(metricPO.getMetricId())
          .withName(metricPO.getMetricName())
          .withNamespace(namespace)
  ...
  public static List<MetricEntity> fromMetricPOs(List<MetricPO> metricPOs, Namespace namespace) {
    return metricPOs.stream()
        .filter(metricPO -> metricPO != null)
        .map(metricPO -> POConverters.fromMetricPO(metricPO, namespace))
        .collect(Collectors.toList());
  }
  ...
  public static MetricVersionEntity fromMetricVersionPO(
    ...
    try {
      ...
      if (StringUtils.isNotBlank(metricVersionPO.getVersionProperties())) {
        properties =
            JsonUtils.anyFieldMapper().readValue(metricVersionPO.getVersionProperties(), Map.class);
      }
  ...
  public static List<MetricVersionEntity> fromMetricVersionPOs(
    ...
    return versionPOs.stream()
        .filter(versionPO -> versionPO != null)
        .map(versionPO -> POConverters.fromMetricVersionPO(versionPO, metricIdent))
        .collect(Collectors.toList());
  }
