...
public class JDBCBackend implements RelationalBackend {
  ...
  public <E extends Entity & HasIdentifier> void insert(E e, boolean overwritten)
    ...
    } else if (e instanceof org.apache.gravitino.meta.MetricEntity) {
      MetricMetaService.getInstance()
          .insertMetric((org.apache.gravitino.meta.MetricEntity) e, overwritten);
  ...
  public <E extends Entity & HasIdentifier> E update(
    ...
    switch (entityType) {
      ...
      case METRIC:
        return (E) MetricMetaService.getInstance().updateMetric(ident, updater);
      case METRIC_VERSION:
