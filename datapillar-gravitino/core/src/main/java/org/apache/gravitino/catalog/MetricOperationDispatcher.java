...
/** MetricOperationDispatcher 负责调度所有指标相关的操作 */
public class MetricOperationDispatcher extends OperationDispatcher implements MetricDispatcher {

  public MetricOperationDispatcher(
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                ...
                c -> c.doWithMetricOps(m -> m.listMetrics(namespace)),
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                ...
                c -> c.doWithMetricOps(m -> m.getMetric(ident)),
  ...
  public Metric registerMetric(
    ...
    Map<String, String> updatedProperties = null;
    if (properties != null) {
      updatedProperties =
          checkAndUpdateProperties(catalogIdent, properties, p -> p.metricPropertiesMetadata());
    }
  ...
  public boolean deleteMetric(NameIdentifier ident) {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.deleteMetric(ident)),
  ...
  public Metric alterMetric(NameIdentifier ident, MetricChange... changes)
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.alterMetric(ident, changes)),
                NoSuchMetricException.class,
  ...
  public int[] listMetricVersions(NameIdentifier ident) throws NoSuchMetricException {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.listMetricVersions(ident)),
                NoSuchMetricException.class));
  }
  ...
  public MetricVersion[] listMetricVersionInfos(NameIdentifier ident) throws NoSuchMetricException {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.listMetricVersionInfos(ident)),
                NoSuchMetricException.class));
  }
  ...
  public MetricVersion getMetricVersion(NameIdentifier ident, int version)
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.getMetricVersion(ident, version)),
  ...
  public boolean deleteMetricVersion(NameIdentifier ident, int version) {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.deleteMetricVersion(ident, version)),
                RuntimeException.class));
  }
  ...
  public Metric switchMetricVersion(NameIdentifier ident, int targetVersion)
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.switchMetricVersion(ident, targetVersion)),
                NoSuchMetricException.class,
                NoSuchMetricVersionException.class));
  }
  ...
  public NameIdentifier[] listMetricModifiers(Namespace namespace) throws NoSuchSchemaException {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(NameIdentifier.of(namespace.levels())),
                c -> c.doWithMetricOps(m -> m.listMetricModifiers(namespace)),
                NoSuchSchemaException.class));
  }
  ...
  public MetricModifier getMetricModifier(NameIdentifier ident) {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.getMetricModifier(ident)),
                RuntimeException.class));
  }
  ...
  public MetricModifier createMetricModifier(
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.createMetricModifier(ident, code, type, comment)),
                NoSuchSchemaException.class));
  }
  ...
  public boolean deleteMetricModifier(NameIdentifier ident) {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.deleteMetricModifier(ident)),
                RuntimeException.class));
  }
  ...
  public NameIdentifier[] listMetricRoots(Namespace namespace) throws NoSuchSchemaException {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(NameIdentifier.of(namespace.levels())),
                c -> c.doWithMetricOps(m -> m.listMetricRoots(namespace)),
                NoSuchSchemaException.class));
  }

  @Override
  public MetricRoot getMetricRoot(NameIdentifier ident) {
    return TreeLockUtils.doWithTreeLock(
        ident,
        LockType.READ,
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.getMetricRoot(ident)),
                RuntimeException.class));
  }

  @Override
  public MetricRoot createMetricRoot(
    ...
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                ...
                c ->
                    c.doWithMetricOps(
                        m -> m.createMetricRoot(ident, code, nameCn, nameEn, comment)),
                NoSuchSchemaException.class));
  }
  ...
  public boolean deleteMetricRoot(NameIdentifier ident) {
    return TreeLockUtils.doWithTreeLock(
        ...
        () ->
            doWithCatalog(
                getCatalogIdentifier(ident),
                c -> c.doWithMetricOps(m -> m.deleteMetricRoot(ident)),
                RuntimeException.class));
  }
