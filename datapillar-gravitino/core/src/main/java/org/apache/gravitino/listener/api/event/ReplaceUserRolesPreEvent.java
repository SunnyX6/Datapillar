...
/** Represents an event triggered before replacing all roles of a user. */
@DeveloperApi
public class ReplaceUserRolesPreEvent extends UserPreEvent {
  private final String userName;
  private final List<String> roles;

  public ReplaceUserRolesPreEvent(
