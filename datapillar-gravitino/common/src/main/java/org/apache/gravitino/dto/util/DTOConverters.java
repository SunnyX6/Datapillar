...
public class DTOConverters {
  ...
  public static MetricDTO toDTO(Metric metric) {
    return MetricDTO.builder()
        ...
        .withLastVersion(metric.lastVersion())
        .withAudit(toDTO(metric.auditInfo()))
        .build();
  }
  ...
  public static MetricVersionDTO toDTO(MetricVersion metricVersion) {
    return MetricVersionDTO.builder()
        ...
        .withRefTableId(metricVersion.refTableId())
        ...
        .withMeasureColumnIds(metricVersion.measureColumnIds())
        .withFilterColumnIds(metricVersion.filterColumnIds())
  ...
  public static MetricDTO[] toDTOs(Metric[] metrics) {
    ...
    return Arrays.stream(metrics).map(DTOConverters::toDTO).toArray(MetricDTO[]::new);
  }
  ...
  public static MetricVersionDTO[] toDTOs(MetricVersion[] metricVersions) {
    if (ArrayUtils.isEmpty(metricVersions)) {
      return new MetricVersionDTO[0];
    }
    return Arrays.stream(metricVersions).map(DTOConverters::toDTO).toArray(MetricVersionDTO[]::new);
  }
