...
/** 表示指标词根的 DTO (Data Transfer Object) */
@NoArgsConstructor(access = AccessLevel.PRIVATE, force = true)
@AllArgsConstructor(access = AccessLevel.PRIVATE)
@EqualsAndHashCode
public class MetricRootDTO implements MetricRoot {
  ...
  /** Builder for constructing a Root DTO. */
  public static class Builder {
    ...
    public MetricRootDTO build() {
      ...
      return new MetricRootDTO(code, nameCn, nameEn, comment, audit);
    }
  }
}
