...
/** Guard for tenant bootstrap permissions in setup flows. */
public final class TenantBootstrapGuard {

  private TenantBootstrapGuard() {}

  public static boolean canCreateMetalake(Principal principal) {
    ...
    return StringUtils.isNotBlank(ExternalUserIdContextHolder.get());
  }
}
